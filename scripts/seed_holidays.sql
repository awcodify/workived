-- Seed public holidays for Workived
-- Indonesian and UAE national public holidays 2025-2027
-- Source: Government of Indonesia & UAE Federal Authority
...
('ID', '2026-03-31', 'Eid Al-Fitr Day 3'),
('ID', '2026-04-01', 'Eid Al-Fitr Day 4'),
...
SELECT 
    COUNT(*) FILTER (WHERE country_code = 'ID') || ' Indonesia holidays' as id_count,
    COUNT(*) FILTER (WHERE country_code = 'AE') || ' UAE holidays' as ae_count,
    COUNT(*) || ' total holidays' as total_count
