...
type mockAttService struct {
	...
	getAllWeekFn        func(ctx context.Context, orgID uuid.UUID, startDate string) ([]attendance.TeamWeekEntry, error)
}
...
func (m *mockAttService) GetAllWeek(ctx context.Context, orgID uuid.UUID, startDate string) ([]attendance.TeamWeekEntry, error) {
	if m.getAllWeekFn != nil {
		return m.getAllWeekFn(ctx, orgID, startDate)
	}
	return nil, nil
}
	...
	svc := &mockAttService{
		dailyReportFn: func(_ context.Context, _ uuid.UUID, f attendance.DailyReportFilters) ([]attendance.DailyEntry, error) {
			...
			return []attendance.DailyEntry{
				{EmployeeID: uuid.MustParse("00000000-0000-0000-0000-000000000001"), EmployeeName: "Employee 1", Status: "present"},
				{EmployeeID: uuid.MustParse("00000000-0000-0000-0000-000000000002"), EmployeeName: "Employee 2", Status: "absent"},
			}, nil
		},
	}
